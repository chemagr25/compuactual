                    ...
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <div class=" gap-2 w-full mt-2 flex flex-wrap">
                                ...
                                <div v-else class="">
                                    <div class="collapse border border-base-300 mb-5 collapse-plus bg-base-200">
                                        <input type="radio" name="my-accordion-3" />
                                        <div class="collapse-title bg-primary  text-xl font-medium">
                                            Dispositivo
                                        </div>
                                        <div
                                            class="collapse-content bg-primary grid grid-cols-4 lg:grid-cols-3 gap-2  m-auto">
                            ...
                            <div class="w-full flex justify-end mt-5">
                                <button :disabled="isLoading" @click="sendService"
