    ...
    <Dialog as="div" @close="closeModal" class="relative z-10">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <DialogPanel
              class="w-full max-w-3xl max-h-[30rem] overflow-auto transform rounded-2xl bg-secondary text-neutral border border-base-300 p-6 text-left align-middle shadow-xl transition-all"
            >
              ...
              <div class="gap-2 w-full mt-2 flex flex-wrap">
                ...
                <div v-else class="w-full">
                  <div
                    class="collapse border w-full border-base-300 mb-5 collapse-plus bg-base-200"
                  >
                    <input type="radio" name="my-accordion-3" />
                    <div class="collapse-title bg-primary text-xl font-medium">Dispositivo</div>
                    <div
                      class="collapse-content w-full bg-primary grid grid-cols-4 lg:grid-cols-3 gap-2 m-auto"
                    >
                      ...
                      <div class="col-span-4 gap-3 grid grid-cols-4 w-full">
                  ...
                  <div class="collapse collapse-plus bg-primary w-full">
                    <input type="radio" name="my-accordion-3" />
                    <div class="collapse-title text-xl bg-primary font-medium">
                      Cliente y técnico
                    </div>
                    <div
                      class="collapse-content w-full bg-primary grid grid-cols-4 lg:grid-cols-4 gap-2 m-auto"
                    >
                      <div class="col-span-2 bg-primary lg:col-span-2">
