...
<template>
  <input type="text" v-model="enterName" placeholder="Técnico" class="input border border-base-300 focus:outline-none w-full bg-primary">

  <div v-if="matchClients.length > 0   || isLoading"
    ...
    <p v-if="!isLoading" v-for="client in matchClients" @click="selectClient(client.id, client.name, client.lastName)"
